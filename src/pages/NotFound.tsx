	...
	return (
		<div className={`min-h-screen bg-white flex items-center justify-center px-6`}>
			<div className="text-center">
				...
				<p className="text-gray-700 mt-6 text-lg">Sorry, the page you're looking for doesn't exist.</p>
				<Link
					to={'/'}
					className={`mt-8 inline-block text-sm  text-black  underline hover:text-gray-700 transition`}
				>
					Go back home
				</Link>
			</div>
